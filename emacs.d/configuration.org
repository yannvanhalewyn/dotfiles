...
** Setup theme and font
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package kaolin-themes :init (load-theme 'kaolin-ocean t))
...
*** Smartparens
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package smartparens
        :defer t
        :init
        (yhv/add-hooks #'smartparens-mode '(coffee-mode-hook ruby-mode-hook js-mode-hook c-mode-common-hook rust-mode-hook))
        :config
        ...
        (sp-local-pair 'java-mode "{" nil :post-handlers '((yvh/newline-in-sexp "RET")))
        (sp-local-pair 'java-mode "{" nil :post-handlers '((yvh/newline-in-sexp "RET")))
        (sp-local-pair 'rust-mode "{" nil :post-handlers '((yvh/newline-in-sexp "RET")))
