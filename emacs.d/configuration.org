...
** Add brews and /usr/local/bin to exec path
   ...
   #+BEGIN_SRC emacs-lisp
     (let ((paths "/Users/yannvanhalewyn/bin:/Users/yannvanhalewyn/.rbenv/shims:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/MacGPG2/bin"))
       (setenv "PATH" paths)
...
*** Clojure mode
    ...
    #+BEGIN_SRC emacs-lisp
      (use-package clojure-mode
        ...
        (dolist (word '(try-let assoc-if t/to-at transform match facts fact assoc render for-all))
