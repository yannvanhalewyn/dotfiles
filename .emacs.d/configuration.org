#+TITLE: Yann's emacs config
#+SETUPFILE: /Users/yannvanhalewyn/.emacs.d/config/org_html.config
...
** Setup theme and font
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package doom-themes :config (load-theme 'doom-solarized-light t) (doom-themes-neotree-config))
     (set-face-attribute 'default nil :font "Source Code Pro" :height 155)
   #+END_SRC
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package doom-modeline
       ...
       (doom-modeline-def-modeline 'yvh/modeline
         ...
         '(misc-info minor-modes major-mode mu4e process vcs checker ci-status))
...
** General (keybindings)
   ...
   #+BEGIN_SRC emacs-lisp
     (keys :prefix "g"
       ...
       "h" (yvh/find-file-i "~/Google Drive/Documents/org/timesheet.org")
...
** Yasnippet
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package yasnippet
       ...
       ;; Use TAB to expand snippets. The code snippet below also
       ;; avoids clashing with company-mode.
...
** Org
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package org
       ...
       (defconst gtd-dir "~/Google Drive/Documents/org")
...
** Mail
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package mu4e-alert
       :config
       ;; (mu4e-alert-set-default-style 'terminal-notifier)
       ;; (mu4e-alert-enable-notifications)
       (mu4e-alert-enable-mode-line-display)
       (setq mu4e-alert-interesting-mail-query "flag:unread and maildir:/brightin/INBOX")
       (keys-l "M" 'mu4e-alert-view-unread-mails))
   #+END_SRC
